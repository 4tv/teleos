export { PublishQueryPayload, Settings, EventHandlers, ReadyOptions, PublishEventHandlers, ReviseEventHandlers, PublishTicket, SuccessfulResponse, };
...
interface PublishEventHandlers {
    ...
    handleFailure: (params: PublishTicket & {
        reason: string;
    }) => void;
}
interface ReviseEventHandlers {
    ...
    handleSuccess: (params: SuccessfulResponse) => void;
    handleFailure: (params: ReviseTicket & {
        reason: string;
    }) => void;
}
